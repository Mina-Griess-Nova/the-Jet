 ...
 <div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">List of  VIP customers</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                        <li class="breadcrumb-item active">vip customer</li>
                    </ul>
                </div>
...
<!-- /Page Wrapper -->
  <!-- Add Modal -->
  <div class="modal fade" id="Add_customers" aria-hidden="true" role="dialog">
    ...
    <script>
        ...
        function vip(customer_id,checkbox){
            ...
            if(value.checked == true){
                ...
                $.ajax({
                    type: 'GET',
                    url: '/{{ Config::get('app.locale') }}/dashboard/customer/vip/'+customer_id,
