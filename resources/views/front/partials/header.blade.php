                   ...
                   <div class=" col-sm-8 col-8" style="padding: 0">
                        ...
                        <div class="collapse navbar-collapse float-right" id="basicExampleNav">
                            ...
                            <ul class="navbar-nav mr-auto">
                                    <li class="nav-item {{ Request::segment(1) == 'dishdivvy' ? 'active' : null }}">
                                        <a class="nav-link" href="{{ url('dishdivvy') }}">VIEW DISHES
                            ...
                            <ul class="cart mt-3 ml-3">
                                ...
                                <i class="fa fa-user-circle" aria-hidden="true" style="font-size: 15px;color:#F4774F"></i>
                                My Account</a>
                                <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink" style="min-width:15rem">
                                    <div class="user-info">
                                        ...
                                        <a class="dropdown-item" href="{{ url('customer/'.auth()->guard('customer')->user()->id) }}">
