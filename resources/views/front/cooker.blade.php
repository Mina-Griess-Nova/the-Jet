        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-8 col-md-12 mt-4">
                    <h4>Hi I’m <span class="mr-2">{{ ucfirst($cook->name) }}</span>!  <span style="font-size: 13px;padding-bottom:5px">{{ $cook->address[0]->city }} ,{{ $cook->address[0]->state }}, ({{  $cook->address[0]->area }})</span></h4>
                    <div class="float-right d-block-xl d-lg-block  d-md-none d-sm-none " style="color: #F4774F">
                ...
                <div class="row  my-5 py-5" style="justify-content:space-around;width:100%">
                    ...
                    <div class="col-xl-8 col-md-12 mt-4">
                        <div class="info px-5">
                            ...
                            <div class="float-right" style="color: #F4774F">
                                <i class="fas fa-share-square mt-3 "></i>
                                <span class="mt-3 mr-3">Share this profile</span>
                                <button type="button" class="btn  waves-effect"> follow</button>
                            </div>
